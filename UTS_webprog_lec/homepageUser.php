    ...
    <div class="">
        ...
        <div class="carousel-inner">
          ...
          <div class="carousel-item">
            <img src="gambar3.png" class="d-block w-100" alt="#">
          </div>
          <div class="carousel-item">
            <img src="gambar4.png" class="d-block w-100" alt="#">
          </div>
        </div>
    ...
    <div class="container mt-5">
        <div class="row">
            <div class="col-md-4 mb-5">
                <img src="katalog1.jpg" alt="" class="img-thumbnail">
            </div>
            <div class="col-md-4 mb-5">
                <img src="katalog1.jpg" alt="" class="img-thumbnail">
            </div>
...
<div id="carouselExampleInterval" class="carousel slide" data-bs-ride="carousel">
    <div class="carousel-inner">
      <div class="carousel-item active" data-bs-interval="10000">
        <img src="diskon2.png" class="d-block w-100" alt="#">
      </div>
      <div class="carousel-item" data-bs-interval="2000">
        <img src="diskon3.png" class="d-block w-100" alt="#">
      </div>
      <div class="carousel-item">
        <img src="diskon2.jpg" class="d-block w-100" alt="#">
      </div>
    </div>
  ...
  <ul class="nav justify-content-center">
    ...
    <li class="nav-item">
      <a class="nav-link text-dark" aria-disabled="true" href="#">LOCATION</a>
    </li>
    <li class="nav-item">
  ...
  <div class="container">
    <ul class="list-inline">
        <li class="list-inline-item">
            <a href=""><img src="logokecil.jpg" alt="" class="img-fluid"></a>
        </li>
        <li class="list-inline-item">
